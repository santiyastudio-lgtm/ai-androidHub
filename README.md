...
**Offline AI assistant for Android.** Run LLMs, generate images, search documents вЂ” all on-device. No cloud. No subscriptions. No data leaves your phone.

[![Platform](https://img.shields.io/badge/Platform-Android_12%2B-3DDC84?logo=android&logoColor=white)](https://github.com/Siddhesh2377/SantiyaLocalAiHub)
...
<p align="left">
  <a href="https://play.google.com/store/apps/details?id=com.santiya.localaihub">
...
[Download APK](https://github.com/Siddhesh2377/SantiyaLocalAiHub/releases) В· [Discord](https://discord.gg/mVPwHDhrAP) В· [Report Issue](https://github.com/Siddhesh2377/SantiyaLocalAiHub/issues)

---

## What It Does

- **Text generation** вЂ” Load any GGUF model (Llama, Mistral, Gemma, Phi, Qwen, etc.) and chat with it locally
- **Image generation** вЂ” Stable Diffusion 1.5 on-device, with inpainting support
- **Image tools** вЂ” Upscale and segment images locally (depth, style transfer, inpainting coming soon)
- **RAG** вЂ” Inject PDFs, Word docs, Excel, EPUB into conversations with semantic search
- **Plugins** вЂ” Web search, file manager, calculator, notepad, date/time, system info, dev utils вЂ” all callable by the LLM
- **AI memory** вЂ” The AI remembers facts about you across conversations, with deduplication and a forgetting curve
- **Text-to-speech** вЂ” 10 voices, 5 languages, on-device synthesis
- **Encrypted storage** вЂ” AES-256-GCM with hardware-backed keys for all chat data
- **System backup** вЂ” Export everything as an encrypted `.tnbackup` file
...
[Google Play](https://play.google.com/store/apps/details?id=com.santiya.localaihub) or [GitHub Releases](https://github.com/Siddhesh2377/SantiyaLocalAiHub/releases).

### 2. Get a model

**From the in-app Model Store (recommended):**
1. Open the drawer menu в†’ Model Store
...
2. Use the model picker in SantiyaLocalAiHub to load it
...
### Text Generation
- Any GGUF model works вЂ” load via file picker (no storage permissions needed, uses SAF)
...
- **Files** вЂ” PDF, Word (.doc/.docx), Excel (.xls/.xlsx), EPUB, TXT
- **Text** вЂ” Paste any text content
- **Chat history** вЂ” Convert past conversations into searchable knowledge
- **Neuron Packets** вЂ” Import encrypted `.neuron` RAG files
...
- **Everything stays on-device.** Conversations, generated images, documents, TTS audio вЂ” none of it leaves your phone.
...
```bash
git clone https://github.com/Siddhesh2377/SantiyaLocalAiHub.git
cd SantiyaLocalAiHub
...
| `ums` | Unified Memory System вЂ” binary record storage with JNI |
...
4. **Test on a real device** вЂ” emulators don't reflect real performance
...
- [llama.cpp](https://github.com/ggerganov/llama.cpp) вЂ” LLM inference engine
- [LocalDream](https://github.com/xororz/local-dream) вЂ” Stable Diffusion on Android
- [ONNX Runtime](https://onnxruntime.ai/) вЂ” TTS inference
- [Mem0](https://github.com/mem0ai/mem0) вЂ” AI memory architecture inspiration
- [SillyTavern](https://github.com/SillyTavern/SillyTavern) вЂ” Character card format reference
- [Apache POI](https://poi.apache.org/), [PDFBox-Android](https://github.com/TomRoush/PdfBox-Android), [EpubLib](https://github.com/psiegman/epublib) вЂ” Document parsing
...
[Apache License 2.0](LICENSE) вЂ” use it, modify it, distribute it. Attribution appreciated.

---

Built by [Siddhesh Sonar](https://github.com/Siddhesh2377)

[Star the repo](https://github.com/Siddhesh2377/SantiyaLocalAiHub) В· [Report a bug](https://github.com/Siddhesh2377/SantiyaLocalAiHub/issues) В· [Join Discord](https://discord.gg/mVPwHDhrAP)
