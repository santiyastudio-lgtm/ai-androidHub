...
class EncryptionManager(private val keyAlias: String) {
    ...
    fun encrypt(data: ByteArray): EncryptedData {
        ...
        //Log.d(TAG, "Encrypted ${data.size} bytes в†’ ${encrypted.size} bytes (${duration}ms)")
    ...
    fun decrypt(encryptedData: EncryptedData): ByteArray {
        ...
        val duration = System.currentTimeMillis() - startTime
        Log.d(TAG, "Decrypted ${encryptedData.data.size} bytes в†’ ${decrypted.size} bytes (${duration}ms)")
