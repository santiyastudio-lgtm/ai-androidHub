...
import com.santiya.localaihub.repo.ums.UmsChatRepository
import com.santiya.localaihub.repo.ums.UmsConfigRepository
import com.santiya.localaihub.repo.ums.UmsKnowledgeRepository
...
object VaultManager {
    ...
    fun deriveAppKey(context: Context): ByteArray {
        ...
        // Hardware-backed keys return null for .encoded вЂ” derive via encrypt+hash
    ...
    private fun deriveFromHardwareKey(key: SecretKey): ByteArray {
        ...
        val fixedIv = "SantiyaLocalAiHubKD".toByteArray() // 12 bytes for GCM
        val spec = javax.crypto.spec.GCMParameterSpec(128, fixedIv)
        val cipher = javax.crypto.Cipher.getInstance("AES/GCM/NoPadding")
        cipher.init(javax.crypto.Cipher.ENCRYPT_MODE, key, spec)
        val ciphertext = cipher.doFinal("SantiyaLocalAiHub-UMS-KeyDerivation".toByteArray())
