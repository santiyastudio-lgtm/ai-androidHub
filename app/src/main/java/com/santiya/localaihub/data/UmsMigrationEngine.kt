...
import com.santiya.localaihub.vault.VaultHelper
...
class UmsMigrationEngine(
    ...
    suspend fun run() {
        ...
        if (VaultManager.modelRepo == null || VaultManager.configRepo == null ||
            ...
            progress.onFatalError(0, "VaultManager repos not initialized вЂ” cannot migrate")
            return
        }
    ...
    // в”Ђв”Ђ Phase 1: Room DB в†’ UMS в”Ђв”Ђ
    ...
    private suspend fun migrateRoomEntities() {
        ...
        // Capture repos with null guard вЂ” bail if VaultManager not ready
        val modelRepo = VaultManager.modelRepo ?: run {
            failures.add("VaultManager not initialized вЂ” cannot migrate"); return
        }
    ...
    // в”Ђв”Ђ Phase 2: VaultHelper в†’ UMS в”Ђв”Ђ
    ...
    // в”Ђв”Ђ Phase 3: Verification в”Ђв”Ђ
