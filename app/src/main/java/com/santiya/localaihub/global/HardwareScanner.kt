...
// в”Ђв”Ђ CPU Topology Data в”Ђв”Ђ
...
// в”Ђв”Ђ Hardware Profile в”Ђв”Ђ
...
object HardwareScanner {
    ...
    // в”Ђв”Ђ Sysfs Topology Scanner в”Ђв”Ђ
    ...
    private fun scanCpuTopology(): CpuTopology {
        return try {
            ...
            // Cores without readable frequency в†’ efficiency fallback
