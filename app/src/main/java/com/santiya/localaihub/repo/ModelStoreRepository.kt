...
import com.santiya.localaihub.global.formatDecimalBytes
...
import java.io.File
import com.santiya.localaihub.network.HuggingFaceClient
import com.santiya.localaihub.network.HuggingFaceFileResponse
...
class ModelStoreRepository(private val context: Context) {
    ...
    fun getDeviceInfo(): Map<String, String> {
        ...
        return mapOf(
            ...
            "totalRamMb" to totalRamMb.toString()
        )
    }
    ...
    private fun getNpuSuffixChain(): List<String>? {
        ...
        // Known 8gen* suffix в†’ slice from that point to include all compatible older builds
