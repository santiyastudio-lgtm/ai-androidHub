package com.santiya.localaihub.neuron_example
...
object RetrievalPipeline {
    ...
    fun query(
        ...
        // 6. Expand by edges вЂ” graph traversal for context
        ...
        // 7. Compress context вЂ” dedup + filter
    ...
    fun compressContext(
        ...
        // Collect chunks ordered by score (highest first вЂ” mitigates "lost in the middle" bias)
        val chunks = results
