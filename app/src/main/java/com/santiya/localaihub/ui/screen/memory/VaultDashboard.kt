package com.santiya.localaihub.ui.screen.memory
...
import com.santiya.localaihub.global.formatCompactDate
import com.santiya.localaihub.viewmodel.memory.VaultManagementViewModel
...
// в”Ђв”Ђ Compact Components в”Ђв”Ђ
    ...
    Surface(
        ...
        Row(
            ...
            Column(modifier = Modifier.weight(1f)) {
                ...
                Text(
                    "${chat.messageCount} msgs  В·  ${formatCompactDate(chat.lastMessageTime ?: chat.createdAt)}",
                    style = MaterialTheme.typography.bodySmall,
                    color = MaterialTheme.colorScheme.onSurfaceVariant
                )
            }
